...
const translations = {
  ...
  ar: {
    ...
    welcomeMessage: "مرحبًا بك في نور الرؤيا، مصدرك لتفسير الأحلام القرآني",
    welcomeSubtitle: "قدّم حلمك واحصل على تفسير مبني على التعاليم الإسلامية",
    landing1: "تفسير الأحلام الإسلامي",
    landing2: "مستوحى من الحكمة القرآنية",
    landing3: "خاص واحترام",
    signUpCta: "سجل لتفسير أحلامك",
